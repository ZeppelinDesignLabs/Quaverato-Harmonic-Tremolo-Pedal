...
2. Using Boards Manager in Arduino, install the MightyCore AtMega 328-PU board.
...
7. Flash the sketch to the pedal. We usually use an independent installation of AVRdUde for this, using this command line:
